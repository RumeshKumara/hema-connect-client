...
export default function LoginPage() {
  ...
  return (
    <section className="min-h-screen bg-[#ededee] px-6 pb-20 pt-10 sm:px-10 sm:pt-12">
      ...
      <div className="mx-auto w-full max-w-md rounded-4xl bg-white p-8 shadow-[0_20px_50px_rgba(0,0,0,0.08)] sm:p-10">
        <h1 className="text-3xl font-bold tracking-tight text-zinc-900">Login</h1>
        <p className="mt-2 text-sm text-zinc-600">Sign in with your account credentials.</p>
